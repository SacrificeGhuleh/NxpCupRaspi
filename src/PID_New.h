...
#define P_ON_E 1
    ...
    PID_new(double *Input, double *Output, double *Setpoint,
            double Kp, double Ki, double Kd, int POn,
            int ControllerDirection);//   Setpoint.  Initial tuning parameters are also set here.
