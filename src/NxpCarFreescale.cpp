...
#define MAX_SERVO_CHANGE 2000
  ...
  void NxpCar::update() {
    ...
    tfc_->getImage(0b00, sendData_.image, TFC_CAMERA_LINE_LENGTH);
    ...
    switch ((NxpModes) tfc_->getDIPSwitch()) {
      case modeSpeedZone: {
        ...
        auto regions = tracer_->getRegions(nxpImage, 10, TFC_CAMERA_LINE_LENGTH - 10, false);
    ...
    const int rightDistance = TFC_CAMERA_LINE_LENGTH - right_;
